...
public class Ornek_AmazonKayitSayfasi extends TestBase  {    // DAY 14 - 6 Eylül 2020 Pazar
    ...
    public void test02(){
        ...
        isim.sendKeys("Ercan Aydin");
        driver.findElement(By.id("ap_email")).sendKeys("ercnaydin1@gmail.com");
        driver.findElement(By.id("ap_password")).sendKeys("2020.8888");
        driver.findElement(By.id("ap_password_check")).sendKeys("2020.8888");
